...
namespace duckling_days.DAL.DBContext;

public partial class CUsersFernaSourceReposDucklingDaysBackendDucklingDaysDalDatabaseDatabaseMdfContext : DbContext
{
    public CUsersFernaSourceReposDucklingDaysBackendDucklingDaysDalDatabaseDatabaseMdfContext()
    {
    }

    public CUsersFernaSourceReposDucklingDaysBackendDucklingDaysDalDatabaseDatabaseMdfContext(DbContextOptions<CUsersFernaSourceReposDucklingDaysBackendDucklingDaysDalDatabaseDatabaseMdfContext> options)
        : base(options)
    {
    }
